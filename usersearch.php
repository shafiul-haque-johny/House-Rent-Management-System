	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         ...
	         <li class="nav-item"><a href="documentation.php" class="nav-link">Documentation</a></li>
	          ...
	          <li class="nav-item"><a href="emergency.php" class="nav-link">Emergency</a></li>
    ...
    <div class="hero-wrap ftco-degree-bg" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
          	<div class="text text-center">
	            <h1 class="mb-4">The Simplest <br>Way to Find your House</h1>
	            <p style="font-size: 18px;"></p>
	            <form action="usersearch.php" method="post" class="search-location mt-md-5">
      ...
      <div class="mouse">
				<a href="#" class="mouse-icon">
					<div class="mouse-wheel"><span class="ion-ios-arrow-round-up"></span></div>
				</a>
			</div>
    </div>
